        ...
        <nav
            ...
            <div class="hs-accordion-group pb-0 px-2  w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                <ul class="space-y-1">
                    ...
                    <li class="hs-accordion" id="department-accordion">
                        <x-side-bar-button :isActive="request()->routeIs('departmentIndex', 'department.*')">
                            <x-svg.department-icon />
                            Department
                            <svg class="hs-accordion-active:hidden ms-auto block size-4"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div id="department-accordion-sub-1-collapse-1"
                            class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden"
                            role="classes" aria-labelledby="department-accordion">
                            <ul class="pt-1 ps-7 space-y-1">
                                <li>
                                    <x-side-bar-link
                                        href="{{ route('department.departmentIndex') }}"><x-svg.add-class-icon /> Add
                                        Department</x-side-bar-link>
                                </li>
                                <li>
                                    <x-side-bar-link
                                        href="{{ route('department.departmentReport') }}"><x-svg.report-icon />
                                        Department Reports</x-side-bar-link>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="hs-accordion" id="subjects-accordion">
                        ...
                        <div id="subjects-accordion-sub-1-collapse-1"
                            ...
                            <ul class="pt-1 ps-7 space-y-1">
                                ...
                                <li>
                                    <x-side-bar-link
                                        href="{{ route('subject.subjectIndex') }}"><x-svg.add-class-icon />
                    ...
                    <li class="hs-accordion" id="assignments-accordion">
                        <x-side-bar-button :isActive="request()->routeIs('assignment.*')">
                        ...
                        <div id="assignments-accordion-sub-1-collapse-1"
                            ...
                            <ul class="pt-1 ps-7 space-y-1">
                                ...
                                <li>
                                    <x-side-bar-link
                                        href="{{ route('assignment.assignmentIndex') }}"><x-svg.add-class-icon />Add
