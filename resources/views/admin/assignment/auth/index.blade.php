...
@section('assignment-index')
    ...
    <form action="{{ route('assignment.assignmentStore') }}" method="POST">
        @csrf
        <div class="flex justify-end m-2">
            <h3 class="text-gray-800 text-base">
                Issue Date: <span id="issueDate" name="issue_date" class="text-lg font-semibold"></span>
            </h3>
            ...
            <div class="sm:col-span-2">
                <div class="w-full">
                    <x-select class="{{ $errors->has('yearLevel') ? 'border-red-500' : '' }}" id="yearLevel"
                        name="yearLevel" placeholder='Select Year Level' value="{{ old('yearLevel') }}"
            ...
            <div class="sm:col-span-2">
                <div class="relative w-full">
                    <x-select class="{{ $errors->has('assignmentType') ? 'border-red-500' : '' }}" name="assignmentType"
                        id="assignmentType" placeholder="Select Assignment Type" value="{{ old('assignmentType') }}"
                        :options="[
                            'Homework' => 'Homework',
                            'Project' => 'Project',
                            'Quiz' => 'Quiz',
            ...
            <div class="sm:col-span-2">
                <div class="relative w-full">
                    <x-select class="{{ $errors->has('submissionMode') ? 'border-red-500' : '' }}" name="submissionMode"
                        id="submissionMode" placeholder="Select Submission Mode" value="{{ old('submissionMode') }}"
                        :options="[
