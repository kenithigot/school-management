...
<head>
    ...
    <title>Edit Department | School Management</title>
                ...
                <x-content>
                    ...
                    <div class="py-2 sm:py-6 lg:px-6 mx-auto">
                        ...
                        <div class="bg-slate-100 rounded-xl shadow-xs p-4 sm:p-7">
                            <div class="mb-8">
                                <a href="{{ route('department.departmentIndex') }}"
                                    class="inline-flex gap-1 items-center mb-2 hover:text-green-500 focus:text-green-500"><svg xmlns="http://www.w3.org/2000/svg"
