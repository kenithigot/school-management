...
@section('register-teacher')
    <form action="{{ route('teacher.store') }}" method="POST">
        ...
        <div class="pb-8">
            ...
            <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                ...
                <div class="sm:col-span-10">
                    <div class="sm:flex">
                        <div class="relative w-full">
                            <x-input-floating class="{{ $errors->has('emailTeacher') ? 'border-red-500' : '' }}"
                                id="emailTeacher" name="emailTeacher" type="email" label="Email Address"
                                placeholder="Email Address" value="{{ old('emailTeacher') }}" />
                            @error('emailTeacher')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
        ...
        <div class="pb-8">
            <x-content-heading>Professional Information</x-content-heading>
            <!-- Grid -->
            <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                ...
                <div class="sm:col-span-10">
                    <div class="w-full">
                        <x-select class="{{ $errors->has('employmentType') ? 'border-red-500' : '' }}" id="employmentType"
                            name="employmentType" placeholder='Select Employment Type' :options="[
                                'Full-time' => 'Full-time',
                                'Part-time' => 'Part-time',
