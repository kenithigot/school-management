    ...
    <div class="@if ($this->getColumnSelectIsHiddenOnMobile()) hidden sm:block @elseif ($this->getColumnSelectIsHiddenOnTablet()) hidden md:block @endif mb-4 w-full md:w-auto md:mb-0 md:ml-2">
        ...
        >
                ...
                <span class="rounded-md shadow-sm">
                    <button
                        ...
                        {{
                            ...
                            ->class([
                                'inline-flex justify-center px-4 py-2 w-full outline:none focus:outline:none text-sm font-medium rounded-md border shadow-sm' => $this->getColumnSelectButtonAttributes()['default-styling'],
                                'text-gray-700 bg-white border-green-500 outline:none focus:outline:none hover:bg-gray-50 focus:border-green-500' => $this->getColumnSelectButtonAttributes()['default-colors'],
                            ])
            ...
            <div
                ...
                class="absolute right-0 z-50 mt-2 w-full rounded-md divide-y border border-green-500 divide-gray-100 shadow-lg origin-top-right md:w-48 focus:outline-none"
            >
                    ...
                    >
                        <div wire:key="{{ $tableName }}-columnSelect-selectAll-{{ rand(0,1000) }}">
                            <label
                                ...
                                class="text-gray-800 inline-flex items-center px-2 py-1 disabled:opacity-50 disabled:cursor-wait"
                            >
                                <input
                                    {{
                                        ...
                                        ->class([
                                            ...
                                            'text-green-500 border-gray-300 focus:border-green-500 focus:ring-green-500' => $this->getColumnSelectMenuOptionCheckboxAttributes()['default-colors'],
                                        ])
                                        ->except(['default-styling', 'default-colors'])
                                    }}
                                    wire:loading.attr="disabled"
                                ...
                                >
                                    <input
                                        {{
                                            ...
                                            ->class([
                                                'transition duration-150 ease-in-out rounded shadow-sm focus:ring focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-wait' => $this->getColumnSelectMenuOptionCheckboxAttributes()['default-styling'],
                                                'text-green-500 border-gray-300' => $this->getColumnSelectMenuOptionCheckboxAttributes()['default-colors'],
                                            ])
                                            ->except(['default-styling', 'default-colors'])
                                        }}
