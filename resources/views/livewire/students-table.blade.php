        ...
        <table class="min-w-full">
            <thead class="border-y bg-green-500 border-gray-200">
                <tr class="text-white text-left">
                    ...
                    <th class="py-3 px-3 font-semibold">Date of Birth</th>
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($students as $student)
                    <tr class="{{ $loop->odd ? 'bg-slate-200' : 'bg-gray-300' }} hover:bg-slate-100">
                        ...
                        <td class="p-3 whitespace-nowrap">{{ $student->first_name . ' ' . $student->middle_name . ' ' . $student->last_name }}</td>
                        <td class="p-3 whitespace-nowrap">
                            {{ $student->date_of_birth }}
                        </td>
                        <td class="p-3 whitespace-nowrap">
                            {{ $student->units }} {{ $student->units > 1 ? 'units' : 'unit' }}
                        </td>
                        <td class="p-3 whitespace-nowrap">
