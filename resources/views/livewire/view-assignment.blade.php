        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-stretch gap-4">
            @forelse ($assignments as $assignment)
                ...
                <div class="h-full flex flex-col">
                    <div
                        class="relative border border-green-500 px-4 py-6 rounded-md shadow-lg flex flex-col h-full bg-slate-200 hover:bg-slate-100">
                        <div
                        ...
                        <h3 class="block text-[16px] font-semibold text-gray-800 my-2">
