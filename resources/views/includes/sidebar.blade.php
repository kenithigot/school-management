<div class="hs-overlay-body-open hs-overlay-body-open:overflow-hidden">
        ...
        <div class="relative flex flex-col h-full max-h-full ">
            ...
            <nav
                ...
                <div class="hs-accordion-group pb-0 px-2  w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                    <ul class="space-y-1">
                        <li>
                            <x-side-bar-link class="bg-green-500 text-white">
                        ...
                        <li class="hs-accordion" id="students-accordion">
                            ...
                            <div id="students-accordion-sub-1-collapse-1"
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            </svg> View Students</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            </svg> Add Student</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            </svg> Edit Student Information</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            </svg> Assign Grades</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                <path
                                                    d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                                            </svg> View Teachers</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-person-add"
                                                ...
                                                <path
                                                    d="M8.256 14a4.5 4.5 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10q.39 0 .74.025c.226-.341.496-.65.804-.918Q8.844 9.002 8 9c-5 0-6 3-6 4s1 1 1 1z" />
                                            </svg> Add Teacher</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-pencil-square"
                                                ...
                                                <path fill-rule="evenodd"
                                                    d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
                                            </svg> Edit Teacher Information</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-clipboard-check"
                                                ...
                                                <path
                                                    d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0z" />
                                            </svg> Assign Classes</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                <path
                                                    d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                                            </svg> View Classes</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            </svg> Add Class</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-person-check"
                                                viewBox="0 0 16 16">
                                                <path
                                                    d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m1.679-4.493-1.335 2.226a.75.75 0 0 1-1.174.144l-.774-.773a.5.5 0 0 1 .708-.708l.547.548 1.17-1.951a.5.5 0 1 1 .858.514M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0M8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4" />
                                                <path
                                                    d="M8.256 14a4.5 4.5 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10q.39 0 .74.025c.226-.341.496-.65.804-.918Q8.844 9.002 8 9c-5 0-6 3-6 4s1 1 1 1z" />
                                            </svg> Assign Teacher to Classes</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-calendar3"
                                                viewBox="0 0 16 16">
                                                <path
                                                    d="M14 0H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2M1 3.857C1 3.384 1.448 3 2 3h12c.552 0 1 .384 1 .857v10.286c0 .473-.448.857-1 .857H2c-.552 0-1-.384-1-.857z" />
                                                <path
                                                    d="M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2" />
                                            </svg> View Class Schedules</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            </svg>Manage Subjects</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-plus-circle"
                                                ...
                                                <path
                                                    d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4" />
                                            </svg> Add New Subject</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                <path
                                                    d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                                            </svg> View Assignments</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-plus-circle"
                                                ...
                                                <path
                                                    d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4" />
                                            </svg> Add Assignment</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            </svg> Grade Assignments</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            </svg> Manage Exams</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-eye"
                                                ...
                                                <path
                                                    d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                                            </svg> View Exam results</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-plus-circle"
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                <path
                                                    d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                                            </svg> View Attendance</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            </svg> Mark Attendance</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                <path
                                                    d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                                            </svg> View Timetable</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-calendar-minus"
                                                viewBox="0 0 16 16">
                                                <path d="M5.5 9.5A.5.5 0 0 1 6 9h4a.5.5 0 0 1 0 1H6a.5.5 0 0 1-.5-.5" />
                                                <path
                                                    d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4z" />
                                            </svg> Edit Timetable</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                <path
                                                    d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                                            </svg> View Books</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-plus-circle"
                                                ...
                                                <path
                                                    d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4" />
                                            </svg> Add New Books</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-journal-richtext"
                                                viewBox="0 0 16 16">
                                                <path
                                            ...
                                            </svg> Manage Book Loans</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                <path
                                                    d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                                            </svg> View Payments</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-plus-circle"
                                                ...
                                                <path
                                                    d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4" />
                                            </svg> Add Payment</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            </svg> Payment History</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                <path
                                                    d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                                            </svg> View Academic Reports</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-gear"
                                                ...
                                                <path
                                                    d="M9.796 1.343c-.527-1.79-3.065-1.79-3.592 0l-.094.319a.873.873 0 0 1-1.255.52l-.292-.16c-1.64-.892-3.433.902-2.54 2.541l.159.292a.873.873 0 0 1-.52 1.255l-.319.094c-1.79.527-1.79 3.065 0 3.592l.319.094a.873.873 0 0 1 .52 1.255l-.16.292c-.892 1.64.901 3.434 2.541 2.54l.292-.159a.873.873 0 0 1 1.255.52l.094.319c.527 1.79 3.065 1.79 3.592 0l.094-.319a.873.873 0 0 1 1.255-.52l.292.16c1.64.893 3.434-.902 2.54-2.541l-.159-.292a.873.873 0 0 1 .52-1.255l.319-.094c1.79-.527 1.79-3.065 0-3.592l-.319-.094a.873.873 0 0 1-.52-1.255l.16-.292c.893-1.64-.902-3.433-2.541-2.54l-.292.159a.873.873 0 0 1-1.255-.52zm-2.633.283c.246-.835 1.428-.835 1.674 0l.094.319a1.873 1.873 0 0 0 2.693 1.115l.291-.16c.764-.415 1.6.42 1.184 1.185l-.159.292a1.873 1.873 0 0 0 1.116 2.692l.318.094c.835.246.835 1.428 0 1.674l-.319.094a1.873 1.873 0 0 0-1.115 2.693l.16.291c.415.764-.42 1.6-1.185 1.184l-.291-.159a1.873 1.873 0 0 0-2.693 1.116l-.094.318c-.246.835-1.428.835-1.674 0l-.094-.319a1.873 1.873 0 0 0-2.692-1.115l-.292.16c-.764.415-1.6-.42-1.184-1.185l.159-.291A1.873 1.873 0 0 0 1.945 8.93l-.319-.094c-.835-.246-.835-1.428 0-1.674l.319-.094A1.873 1.873 0 0 0 3.06 4.377l-.16-.292c-.415-.764.42-1.6 1.185-1.184l.292.159a1.873 1.873 0 0 0 2.692-1.115z" />
                                            </svg> Generate Reports</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                <path
                                                    d="M9.796 1.343c-.527-1.79-3.065-1.79-3.592 0l-.094.319a.873.873 0 0 1-1.255.52l-.292-.16c-1.64-.892-3.433.902-2.54 2.541l.159.292a.873.873 0 0 1-.52 1.255l-.319.094c-1.79.527-1.79 3.065 0 3.592l.319.094a.873.873 0 0 1 .52 1.255l-.16.292c-.892 1.64.901 3.434 2.541 2.54l.292-.159a.873.873 0 0 1 1.255.52l.094.319c.527 1.79 3.065 1.79 3.592 0l.094-.319a.873.873 0 0 1 1.255-.52l.292.16c1.64.893 3.434-.902 2.54-2.541l-.159-.292a.873.873 0 0 1 .52-1.255l.319-.094c1.79-.527 1.79-3.065 0-3.592l-.319-.094a.873.873 0 0 1-.52-1.255l.16-.292c.893-1.64-.902-3.433-2.541-2.54l-.292.159a.873.873 0 0 1-1.255-.52zm-2.633.283c.246-.835 1.428-.835 1.674 0l.094.319a1.873 1.873 0 0 0 2.693 1.115l.291-.16c.764-.415 1.6.42 1.184 1.185l-.159.292a1.873 1.873 0 0 0 1.116 2.692l.318.094c.835.246.835 1.428 0 1.674l-.319.094a1.873 1.873 0 0 0-1.115 2.693l.16.291c.415.764-.42 1.6-1.185 1.184l-.291-.159a1.873 1.873 0 0 0-2.693 1.116l-.094.318c-.246.835-1.428.835-1.674 0l-.094-.319a1.873 1.873 0 0 0-2.692-1.115l-.292.16c-.764.415-1.6-.42-1.184-1.185l.159-.291A1.873 1.873 0 0 0 1.945 8.93l-.319-.094c-.835-.246-.835-1.428 0-1.674l.319-.094A1.873 1.873 0 0 0 3.06 4.377l-.16-.292c-.415-.764.42-1.6 1.185-1.184l.292.159a1.873 1.873 0 0 0 2.692-1.115z" />
                                            </svg> Manage Notifications</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-send-check"
                                                viewBox="0 0 16 16">
                                                <path
                                            ...
                                            </svg> Send Notifications</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="hs-accordion" id="admin-settings-accordion">
                            <x-side-bar-button>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    fill="currentColor" class="bi bi-database-fill-gear" viewBox="0 0 16 16">
                                    <path
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                <path
                                                    d="M9.796 1.343c-.527-1.79-3.065-1.79-3.592 0l-.094.319a.873.873 0 0 1-1.255.52l-.292-.16c-1.64-.892-3.433.902-2.54 2.541l.159.292a.873.873 0 0 1-.52 1.255l-.319.094c-1.79.527-1.79 3.065 0 3.592l.319.094a.873.873 0 0 1 .52 1.255l-.16.292c-.892 1.64.901 3.434 2.541 2.54l.292-.159a.873.873 0 0 1 1.255.52l.094.319c.527 1.79 3.065 1.79 3.592 0l.094-.319a.873.873 0 0 1 1.255-.52l.292.16c1.64.893 3.434-.902 2.54-2.541l-.159-.292a.873.873 0 0 1 .52-1.255l.319-.094c1.79-.527 1.79-3.065 0-3.592l-.319-.094a.873.873 0 0 1-.52-1.255l.16-.292c.893-1.64-.902-3.433-2.541-2.54l-.292.159a.873.873 0 0 1-1.255-.52zm-2.633.283c.246-.835 1.428-.835 1.674 0l.094.319a1.873 1.873 0 0 0 2.693 1.115l.291-.16c.764-.415 1.6.42 1.184 1.185l-.159.292a1.873 1.873 0 0 0 1.116 2.692l.318.094c.835.246.835 1.428 0 1.674l-.319.094a1.873 1.873 0 0 0-1.115 2.693l.16.291c.415.764-.42 1.6-1.185 1.184l-.291-.159a1.873 1.873 0 0 0-2.693 1.116l-.094.318c-.246.835-1.428.835-1.674 0l-.094-.319a1.873 1.873 0 0 0-2.692-1.115l-.292.16c-.764.415-1.6-.42-1.184-1.185l.159-.291A1.873 1.873 0 0 0 1.945 8.93l-.319-.094c-.835-.246-.835-1.428 0-1.674l.319-.094A1.873 1.873 0 0 0 3.06 4.377l-.16-.292c-.415-.764.42-1.6 1.185-1.184l.292.159a1.873 1.873 0 0 0 2.692-1.115z" />
                                            </svg> Manage Users</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-shield-check"
                                                viewBox="0 0 16 16">
                                                <path
                                            ...
                                            </svg>Roles and Permissions</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-building-exclamation"
                                                viewBox="0 0 16 16">
                                                <path
                                            ...
                                            </svg>School Information</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-sliders"
                                                viewBox="0 0 16 16">
                                                <path fill-rule="evenodd"
                                                    d="M11.5 2a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3M9.05 3a2.5 2.5 0 0 1 4.9 0H16v1h-2.05a2.5 2.5 0 0 1-4.9 0H0V3zM4.5 7a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3M2.05 8a2.5 2.5 0 0 1 4.9 0H16v1H6.95a2.5 2.5 0 0 1-4.9 0H0V8zm9.45 4a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3m-2.45 1a2.5 2.5 0 0 1 4.9 0H16v1h-2.05a2.5 2.5 0 0 1-4.9 0H0v-1z" />
                                            </svg>General Settings</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-newspaper"
                                                viewBox="0 0 16 16">
                                                <path
                                                    d="M0 2.5A1.5 1.5 0 0 1 1.5 1h11A1.5 1.5 0 0 1 14 2.5v10.528c0 .3-.05.654-.238.972h.738a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 1 1 0v9a1.5 1.5 0 0 1-1.5 1.5H1.497A1.497 1.497 0 0 1 0 13.5zM12 14c.37 0 .654-.211.853-.441.092-.106.147-.279.147-.531V2.5a.5.5 0 0 0-.5-.5h-11a.5.5 0 0 0-.5.5v11c0 .278.223.5.497.5z" />
                                                <path
                                                    d="M2 3h10v2H2zm0 3h4v3H2zm0 4h4v1H2zm0 2h4v1H2zm5-6h2v1H7zm3 0h2v1h-2zM7 8h2v1H7zm3 0h2v1h-2zm-3 2h2v1H7zm3 0h2v1h-2zm-3 2h2v1H7zm3 0h2v1h-2z" />
                                            </svg>System Logs</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                ...
                                                <path
                                                    d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0" />
                                            </svg>View Activity Logs</x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-exclamation-circle"
                                                viewBox="0 0 16 16">
                                                <path
                                                    d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                                                <path
                                                    d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0M7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0z" />
                                            </svg>Error Logs</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="pt-1 ps-7 space-y-1">
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            </svg>FAQs </x-side-bar-link>
                                    </li>
                                    <li>
                                        <x-side-bar-link><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-person-lock"
                                                viewBox="0 0 16 16">
                                                <path
                                            ...
                                            </svg>Contact Support</x-side-bar-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
    ...
    <div class="sm:hs-overlay-layout-open:ms-72 min-h-160 transition-all duration-300">
        <!-- Navigation Toggle -->
        <div class=" bg-green-400 p-4 py-6 sm:py-6">
            <div class="flex justify-end">
                <button type="button"
                    class="cursor-pointer sm:hidden flex justify-center items-center gap-x-3 size-8 text-sm bg-slate-100 text-gray-800 rounded-lg disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-gray-100"
                ...
                <div>
                    <div class="hs-dropdown relative inline-flex z-1">
                        <button id="hs-dropdown-with-header" type="button"
                            class="cursor-pointer hs-dropdown-toggle py-2 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none aria-haspopup="menu"
                        ...
                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg mt-2"
                            ...
                            <div class="p-1 space-y-0.5">
                                ...
                                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100"
                                    href="#">
                                    <svg class="shrink size-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
